...
<body>
    ...
    <div class="affiliate-container">
        ...
        <!-- Card 1: UserInterviews (Uses your local MP4 file) -->
        ...
        <!-- Card 2: ElevenLabs (Uses a DIFFERENT YouTube embed) -->
        <div class="brain-rot-card" style="border-color: #00d1ff;">
            <div class="badge" style="background: #00d1ff;">🎙️ PRO VOICE ENGINE</div>
            <h2>ElevenLabs AI</h2>
            <div class="video-container">
                <!-- REPLACE 'YOUR_ELEVENLABS_VIDEO_ID_HERE' WITH YOUR NEW YOUTUBE ID LATER -->
                <iframe src="https://www.youtube.com/embed/YOUR_ELEVENLABS_VIDEO_ID_HERE?autoplay=1&mute=1&loop=1" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
            </div>
...
print("✅ Videos explicitly separated. Layout constraints applied.")
